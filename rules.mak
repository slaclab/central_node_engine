...
# Rules for CENTRAL_NODE makefiles
...
# don't apply ADD_updir to cpswlib_DIRS because CENTRAL_NODE_DIR already was 'upped'.
# This means that e.g. yaml_cpplib_DIR must be absolute or relative to CENTRAL_NODE_DIR
