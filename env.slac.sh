...
if [ -z $ARCH ] ; then
  ...
  export LD_LIBRARY_PATH=/afs/slac/g/lcls/package/boost/$BOOSTVERS/$ARCH/lib:/afs/slac/g/lcls/package/yaml-cpp/yaml-cpp-$YAMLCPPVERS/$ARCH/lib:/afs/slac/g/lcls/package/cpsw/framework/$CPSWVERS/$ARCH/lib
