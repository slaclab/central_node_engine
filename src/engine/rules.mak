...
# don't apply ADD_updir to cpswlib_DIRS because CENTRAL_NODE_ENGINE_DIR already was 'upped'.
# This means that e.g. boostlib_DIR must be absolute or relative to CENTRAL_NODE_ENGINE_DIR
