...
void Tester::rxHandlerMain()
{
    ...
    if (rxPackets)
    {
        ...
        outFileSizes << "# Min timestamp delta (ns)        : " << histTSDelta.begin()->first  << "\n";
        outFileSizes << "# Max timestamp delta (ns)        : " << histTSDelta.rbegin()->first << "\n";
        ...
        outFileTSDelta << "# Min timestamp delta (ns)        : " << histTSDelta.begin()->first  << "\n";
        outFileTSDelta << "# Max timestamp delta (ns)        : " << histTSDelta.rbegin()->first << "\n";
        ...
        outFileInfo << "# Min timestamp delta (ns)        : " << histTSDelta.begin()->first  << "\n";
        outFileInfo << "# Max timestamp delta (ns)        : " << histTSDelta.rbegin()->first << "\n";
        outFileInfo << "# FW SoftwareLossCnt              : " << packetLossCnt               << "\n";
        outFileInfo << "# FW SoftwareOvflCnt              : " << packetOverflowCnt           << "\n";
        outFileInfo << "#\n";
